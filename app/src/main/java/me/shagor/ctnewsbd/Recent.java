...
/**
 *Created by shagor on 7/20/2017.
 */

public class Recent extends Fragment implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {

    private static final String url = Config.englishSelecetdURL;
    private List<Movie> recentrList = new ArrayList<Movie>();
    private boolean refreshrecent=false;
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState) {
        ...
        listrecent = (ListView) view.findViewById(R.id.list);
        cmadapter = new CustomListAdapter(getContext(), recentrList);
        listrecent.setAdapter(cmadapter);
        ...
        listrecent.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                int topRowVerticalPosition =
                        (listrecent == null || listrecent.getChildCount() == 0) ?
                                0 : listrecent.getChildAt(0).getTop();
        ...
        if(internetcheck)
            ...
            Cursor c = dbHelper.getAllData("latest");
                        ...
                        if (p < 3) {
                            ...
                            for (String name : Hash_file_maps1.keySet()) {
                                ...
                                textSliderView
                                        ...
                                        .setOnSliderClickListener(Recent.this);
                        ...
                        public void onResponse(JSONArray response) {
                                ...
                                for (int i = 0; i < response.length(); i++) {
                                    try {
                                        ...
                                        if (i < 3) {
                                            ...
                                            sliderLayout.addOnPageChangeListener(Recent.this);
                                           dbHelper.insertData("latest",obj.getString("postId"),obj.getString("title"),obj.getString("image"),obj.getString("date"));
                            ...
                            listrecent.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                    ...
                                    String postid = recentrList.get(position).getId();
